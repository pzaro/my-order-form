...
const sciBurnOutLipo = {
    act: "Ανά κάψουλα: Εκχύλισμα φύλλων πράσινου τσαγιού (Camellia sinensis) 200 mg [πολυφαινόλες 80 mg, κατεχίνες 40 mg, EGCG 14 mg], καφεΐνη 150 mg, L-carnitine L-tartrate 130 mg [L-carnitine 88.4 mg], cayenne pepper (Capsicum annuum) powder 100 mg, L-τυροσίνη 75 mg, ταυρίνη 75 mg, χιτοζάνη 50 mg, εκχύλισμα ρίζας ginger (Zingiber officinale) 20 mg [gingerols 1 mg], εκχύλισμα black pepper (Piper nigrum) 2.5 mg [piperine 2.375 mg], βιταμίνη B6 1 mg, βιταμίνη B12 1 mg όπως αναγράφεται στην παρεχόμενη ετικέτα (η αντιστοίχιση με το %NRV της ετικέτας χρειάζεται επιβεβαίωση), χρώμιο 98 μg. Ημερήσια μερίδα: 2 κάψουλες.",
    ind: "Στην εμπρόσθια ετικέτα αναφέρονται: Normal Macronutrient Metabolism και Normal Blood Glucose Levels. Η φόρμουλα φέρει επίσης ένδειξη High caffeine content. Η ημερήσια μερίδα 2 καψουλών αποδίδει 300 mg καφεΐνης.",
    mech: "Καφεΐνη: ανταγωνισμός υποδοχέων αδενοσίνης A1/A2A στο ΚΝΣ, με αύξηση εγρήγορσης και ενίσχυση συμπαθητικής/κατεχολαμινεργικής σηματοδότησης· μπορεί οξέως να αυξήσει τη λιπόλυση και τη θερμογένεση, χωρίς αυτό να ισοδυναμεί από μόνο του με κλινικά σημαντική απώλεια λίπους. Πράσινο τσάι/κατεχίνες/EGCG: πολυφαινολικά συστατικά με αντιοξειδωτική δράση και πιθανή επίδραση στη διαχείριση κατεχολαμινών/θερμογένεση· η κλινική επίδραση είναι συνήθως μέτρια και εξαρτάται από δόση και καφεΐνη. L-carnitine: συμμετέχει στο carnitine shuttle (CPT-I/CACT/CPT-II), μεταφέροντας μακράς αλύσου λιπαρά οξέα στο μιτοχόνδριο για β-οξείδωση· σε άτομα χωρίς έλλειψη η από του στόματος λήψη δεν συνεπάγεται αυτόματα μεγαλύτερη οξείδωση λίπους. Cayenne/capsaicinoids: ενεργοποίηση TRPV1 με θερμογενετική/συμπαθητική σηματοδότηση, αλλά εδώ δεν δηλώνεται τυποποίηση σε capsaicinoids. L-τυροσίνη: πρόδρομος ντοπαμίνης/νοραδρεναλίνης και υποστηρίζει τη σύνθεση κατεχολαμινών κυρίως σε συνθήκες οξέος stress. Ταυρίνη: ωσμορρύθμιση, ρύθμιση Ca2+ και σταθεροποίηση κυτταρικών μεμβρανών. Χιτοζάνη: κατιονικός πολυσακχαρίτης που μπορεί να δεσμεύει μέρος λιπιδίων/χολικών οξέων στον γαστρεντερικό αυλό, όμως η ποσότητα της φόρμουλας είναι πολύ χαμηλότερη από τις δόσεις γραμμαρίων που συνήθως μελετώνται. Ginger/gingerols: επίδραση σε οξειδωτικά και φλεγμονώδη μονοπάτια και στη γαστρεντερική κινητικότητα. Piperine: μπορεί να μεταβάλλει εντερική απορρόφηση και μεταβολισμό συγχορηγούμενων ουσιών, άρα απαιτείται προσοχή σε πιθανές αλληλεπιδράσεις. Vitamin B6: PLP-εξαρτώμενο συνένζυμο στον μεταβολισμό αμινοξέων/γλυκογόνου και στη φυσιολογική ενεργειακή λειτουργία. Chromium: συμβάλλει στον φυσιολογικό μεταβολισμό των μακροθρεπτικών συστατικών και στη διατήρηση φυσιολογικών επιπέδων γλυκόζης στο αίμα. Οι μηχανισμοί περιγράφουν βιολογική βάση και δεν αποτελούν ισχυρισμό θεραπείας ή εγγυημένης απώλειας βάρους."
};

const sciZMA = {
    act: "ZMA = συνδυασμός Μαγνησίου, Ψευδαργύρου και Βιταμίνης B6. Η δημόσια καταχώριση του συγκεκριμένου Nutri-MX ZMA επιβεβαιώνει τα τρία αυτά μικροθρεπτικά συστατικά, όμως η εμπρόσθια φωτογραφία δεν επιτρέπει ασφαλή καταχώριση των ακριβών mg ανά κάψουλα. Συσκευασία: 30 κάψουλες.",
    ind: "Μυϊκή λειτουργία και αποκατάσταση διατροφικών αναγκών σε μαγνήσιο/ψευδάργυρο/B6. Ο ψευδάργυρος συμβάλλει στη φυσιολογική πρωτεϊνοσύνθεση και στη διατήρηση φυσιολογικών επιπέδων τεστοστερόνης στο αίμα. Το μαγνήσιο συμβάλλει στη φυσιολογική μυϊκή λειτουργία, στη φυσιολογική πρωτεϊνοσύνθεση, στον φυσιολογικό ενεργειακό μεταβολισμό και στη μείωση της κόπωσης. Η βιταμίνη B6 συμβάλλει στον φυσιολογικό μεταβολισμό πρωτεϊνών/γλυκογόνου, στη ρύθμιση της ορμονικής δραστηριότητας και στη μείωση της κόπωσης.",
    mech: "Magnesium: λειτουργεί κυρίως ως Mg-ATP σύμπλοκο και ως συμπαράγοντας σε εκατοντάδες ενζυμικές αντιδράσεις, επηρεάζοντας παραγωγή ATP, νευρομυϊκή διεγερσιμότητα, διακίνηση Ca2+/K+ και φυσιολογική σύσπαση/χάλαση μυών. Zinc: δομικός και καταλυτικός συμπαράγοντας σε εκατοντάδες ένζυμα και zinc-finger μεταγραφικούς παράγοντες· συμμετέχει στη σύνθεση DNA/RNA και πρωτεϊνών και στη φυσιολογική ενδοκρινική λειτουργία. Η ένδειξη για τεστοστερόνη αφορά διατήρηση φυσιολογικών επιπέδων και όχι αύξηση πάνω από το φυσιολογικό σε μη ελλειμματικά άτομα. Vitamin B6 (PLP): συνένζυμο σε τρανσαμινώσεις/αποκαρβοξυλιώσεις αμινοξέων, στον μεταβολισμό γλυκογόνου και στη σύνθεση νευροδιαβιβαστών. Ως συνδυασμός, το ZMA στοχεύει κυρίως στην κάλυψη/αποκατάσταση μικροθρεπτικών αναγκών που σχετίζονται με μυϊκή λειτουργία, ενεργειακό μεταβολισμό και φυσιολογική ορμονική λειτουργία· δεν τεκμηριώνεται ότι αυξάνει τεστοστερόνη ή μυϊκή μάζα σε άτομα με επαρκή πρόσληψη μόνο και μόνο επειδή λαμβάνεται ως ZMA."
};

// Εγγραφή των νέων NUTRI-MX στην εμπορική πολιτική του order form.
// Το index.html ορίζει NUTRI_MX_PRODUCTS και MIX_GROUPS μετά τη φόρτωση του products.js.
// Το handler εκτελείται πρώτο στο DOMContentLoaded και προσθέτει με ασφαλή τρόπο τα νέα προϊόντα.
document.addEventListener("DOMContentLoaded", () => {
    const newNutriMXProducts = [
        'NUTRI-MX BURN OUT LIPO 90 caps',
        'NUTRI-MX ZMA 30 caps'
    ];

    try {
        if (typeof NUTRI_MX_PRODUCTS !== "undefined") {
            newNutriMXProducts.forEach(name => {
                if (!NUTRI_MX_PRODUCTS.includes(name)) NUTRI_MX_PRODUCTS.push(name);
            });
        }

        if (typeof MIX_GROUPS !== "undefined") {
            const nutriGroup = MIX_GROUPS.find(group => group.code === "NUTRI_MX");
            if (nutriGroup) {
                newNutriMXProducts.forEach(name => {
                    if (!nutriGroup.products.includes(name)) nutriGroup.products.push(name);
                });
            }
        }
    } catch (e) {
        console.warn("Nutri-MX commercial policy registration warning:", e);
    }
});
...
const products = [
    ...
    { name: 'NUTRI-MX BURN OUT LIPO 90 caps', price: 20.90, retailPrice: 35.00, img: "https://github.com/pzaro/my-order-form/blob/main/images/LIPO.png?raw=true", sci: sciBurnOutLipo },
    { name: 'NUTRI-MX ZMA 30 caps', price: 8.36, retailPrice: 14.00, img: "https://github.com/pzaro/my-order-form/blob/main/images/zma.png?raw=true", sci: sciZMA },
