// ============================================================
// ZARKOLIA HEALTH - ULTIMATE PRODUCT DATABASE v33.0
// ============================================================
...
const productDetails = {
    ...
    "Revitace Eyes Luce": {
        ...
        biblio: ["Gallelli L (2019). Escin review. <a href='https://pubmed.ncbi.nlm.nih.gov/31562234/' target='_blank'>PubMed:31562234</a>"]
    },
    ...
    "NUTRI MX MAGNESIUM": {
        moa: [
            { ing: "Magnesium & B6", moa: "<strong>NMDA Modulation:</strong> Ρύθμιση νευρομυϊκής διεγερσιμότητας στους νευρώνες, προκαλώντας μυϊκή και νευρική χαλάρωση." }
        ],
