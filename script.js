...
const productDetails = [
    ...
    { // 12. NUTRI MX PROBIOTIC PREMIUM
        name: 'NUTRI MX PROBIOTIC PREMIUM',
        description: {
            consumer: `<h3>Συμπλήρωμα Διατροφής με Προβιοτικά</h3><p>Το Probiotic Premium της Nutri-MX περιέχει <strong>18 διαφορετικά ενεργά στελέχη προβιοτικών</strong> και <strong>10 δισεκατομμύρια CFU</strong>. Τα προβιοτικά υποστηρίζουν το ανοσοποιητικό σύστημα, τον μεταβολισμό και την πέψη, βοηθώντας στη διατήρηση ή αποκατάσταση της υγιούς μικροχλωρίδας του εντέρου.</p>`,
            science: `<h3>Μηχανισμός Δράσης & Οφέλη</h3><p><strong>Υγεία Γαστρεντερικού:</strong> Τα προβιοτικά συμβάλλουν στη διατήρηση της υγείας του ΓΕΣ και έχουν μελετηθεί για την επίδρασή τους σε ποικίλες παθήσεις [2].</p><p><strong>Μικροβίωμα:</strong> Η ισορροπία του εντερικού μικροβιώματος είναι κρίσιμη για την αποφυγή ασθενειών [5].</p><p><strong>Λειτουργίες:</strong> Παράγουν ουσίες με επιθυμητά αποτελέσματα και επηρεάζουν την ανοσολογική απόκριση [3].</p>`,
            bibliography: `<ol><li>Γεώργιος Π. Καραμανώλης, ΕΚΠΑ, 14η Πανελλήνια Εκπαιδευτική Συνάντηση ΕΛΙΓΑΣΤ, 2019.</li><li>ΚΩΝΣΤΑΝΤΙΝΑ ΤΣΟΥΤΣΟΥΛΟΠΟΥΛΟΥ, MedNutrition, 2023.</li><li>Ευανθία Λιτοπούλου, Προβιοτικά τρόφιμα, Α.Π.Θ., 2013.</li><li>Παναγιώτης Νεύρας, Ποιο προβιοτικό είναι κατάλληλο για εμένα, 2020.</li><li>Lee JY, et al. The microbiome and gut homeostasis. Science 2022.</li></ol>`
        }
    },
    { // 13. NUTRI MX MAGNESIUM 1 Τεμ
        name: 'NUTRI MX MAGNESIUM 1 Τεμ',
        description: {
            consumer: `<h3>Υγεία Νευρικού & Μυϊκού Συστήματος</h3><p>Το μαγνήσιο και η βιταμίνη Β6 συμβάλλουν στη φυσιολογική λειτουργία του νευρικού συστήματος, των ψυχολογικών λειτουργιών και στη μείωση της κόπωσης. Το μαγνήσιο προάγει την ισορροπία των ηλεκτρολυτών και τη λειτουργία των μυών, ενώ η Β6 υποστηρίζει τον μεταβολισμό των πρωτεϊνών και την ορμονική ρύθμιση.</p>`,
            science: `<h3>Βιολογικός Ρόλος & Μηχανισμός</h3><p><strong>Μαγνήσιο:</strong> Συμμετέχει ως συμπαράγοντας σε 300+ χημικές αντιδράσεις (σύνθεση DNA/πρωτεϊνών, νευροδιαβίβαση, μυϊκή σύσπαση). Δρα ως φυσικός ανταγωνιστής ασβεστίου. Η έλλειψη προκαλεί μυϊκούς σπασμούς, κόπωση και ημικρανίες.</p><p><strong>Συνιστώμενη Πρόσληψη:</strong> 320-420 mg ημερησίως για ενήλικες.</p>`,
    ...
    { // 14. NUTRI MX A-Z
        name: 'NUTRI MX A-Z',
        description: {
            consumer: `<h3>Πολυβιταμίνη για Όλη την Οικογένεια</h3><p>Το A-Z Multivitamin and Minerals παρέχει έναν ισορροπημένο συνδυασμό βιταμινών και μετάλλων. Ιδανικό για αθλητές, άτομα με έντονη δραστηριότητα ή όσους θέλουν να ενισχύσουν το ανοσοποιητικό τους και να καλύψουν διατροφικά κενά.</p>`,
            science: `<h3>Οφέλη για Ειδικές Ομάδες</h3><p><strong>Υποστήριξη:</strong> Σε περιόδους στρες ή κακής διατροφής.</p><p><strong>Ειδικές Ανάγκες:</strong> Κατάλληλο για ηλικιωμένους με αυξημένες απαιτήσεις, χορτοφάγους που στερούνται συγκεκριμένων βιταμινών και άτομα σε δίαιτα.</p>`,
    ...
    { // 15. NUTRI MX OMEGA 3
        ...
        description: {
            consumer: `<h3>Καρδιαγγειακή & Ψυχική Υγεία</h3><p>Τα ωμέγα-3 λιπαρά οξέα είναι πολύτιμα για την καρδιαγγειακή υγεία, μειώνοντας τη φλεγμονή και προάγοντας την πήξη του αίματος. Βοηθούν επίσης στην ψυχική υγεία αυξάνοντας τη σεροτονίνη και βελτιώνουν την υγεία του δέρματος, μειώνοντας φλεγμονές όπως η ακμή.</p>`,
            science: `<h3>Μηχανισμοί Δράσης</h3><p><strong>Καρδιαγγειακό:</strong> Μείωση φλεγμονής, βελτίωση λιπιδαιμικού προφίλ.</p><p><strong>Νευρικό Σύστημα:</strong> Υποστήριξη επιπέδων σεροτονίνης.</p><p><strong>Δέρμα:</strong> Μείωση φλεγμονωδών δερματικών καταστάσεων.</p>`,
            bibliography: `<p>Δεν παρέχεται συγκεκριμένη λίστα βιβλιογραφίας.</p>`
        }
    },
    { // 16. NUTRI MX JOINT
        name: 'NUTRI MX JOINT',
        description: {
            consumer: `<h3>Υποστήριξη Αρθρώσεων & Χόνδρων</h3><p>Το Joint Support περιέχει Γλυκοζαμίνη, Χονδροϊτίνη, MSM και Κολλαγόνο. Υποστηρίζει την ευκαμψία των αρθρώσεων, μειώνει τον πόνο και αναγεννά τον χόνδρο. Το Τζίντζερ παρέχει επιπλέον αντιφλεγμονώδη δράση.</p>`,
            science: `<h3>Μηχανισμοί Δράσης</h3><p><strong>Γλυκοζαμίνη:</strong> Αμινοσάκχαρο απαραίτητο για την επιδιόρθωση των αρθρώσεων [2].</p><p><strong>Χονδροϊτίνη:</strong> Αυξάνει την ελαστικότητα του χόνδρου και μειώνει τον πόνο [1].</p><p><strong>MSM:</strong> Παρέχει οργανικό θείο, ενισχύει την αντιοξειδωτική άμυνα και μειώνει τη φλεγμονή [3].</p><p><strong>Κολλαγόνο:</strong> Κύριο δομικό στοιχείο τενόντων και χόνδρου (Τύπος Ι & ΙΙ) [4, 5].</p>`,
            bibliography: `<ol><li>Ειρήνης Μιχαήλ, MedNutrition, ΛΕΞΙΚΟ ΔΙΑΤΡΟΦΗΣ...</li><li>Έφη Δασκάλου, MSM μια φυσική πηγή θείου...</li><li>Μαριάννα Χ. Αντωνέλου, ΕΚΠΑ, ΕΞΩΚΥΤΤΑΡΙΕΣ ΟΥΣΙΕΣ...</li><li>Kislingh – Role of peptide fragments of collagen...</li></ol>`
        }
    }
];
