...
// **ΔΙΟΡΘΩΜΕΝΗ ΛΟΓΙΚΗ:** Βρίσκει το προϊόν με βάση τον αριθμητικό δείκτη (index)
function showProductDetails(productIndex){
    ...
    if(p){
        modalProductName.textContent = products[productIndex].name; // Παίρνουμε το όνομα από την αρχική λίστα
