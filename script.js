// ============================================================
// ZARKOLIA HEALTH - FULL LOGIC & DATABASE
// ============================================================
...
// --- 4. ΠΛΗΡΕΙΣ EVIDENCE-BASED ΠΕΡΙΓΡΑΦΕΣ ---
const productDetails = [
    {
        ...
        description: {
            ...
            science: `<h3>Επιστημονική Ανάλυση</h3>${hcpTable([{ing:"Alcohol denat. ~70%", moa:"Αποδιάταξη πρωτεϊνών και διαταραχή λιπιδικής μεμβράνης μικροοργανισμών."}, {ing:"PMD (p-menthane-3,8-diol)", moa:"Απωθητικό προφίλ μέσω παρεμβολής σε οσφρητικούς υποδοχείς εντόμων."}])}`,
            bibliography: "<ol><li>Carroll SP & Loye J (2006). PMD botanical mosquito repellent.</li><li>CDC Guidelines on Repellents (2023).</li></ol>"
        }
    },
    {
        ...
        description: {
            consumer: consumerBlock({
                ...
                bullets: ["Καθημερινή χρήση σε ξηρό ή ευαίσθητο δέρμα.","Υποστηρίζει τη φυσική διαδικασία αποκατάστασης του φραγμού.","Ιδανική για περιοχές που «τραβάνε»."],
            ...
            bibliography: "<p>Öztürk N, et al. (2007). Hypericum perforatum on skin wounds. | Paraschos S, et al. (2012).</p>"
        }
    },
    {
        ...
        description: {
            consumer: consumerBlock({
                ...
                bullets: ["Σύνθεση με Ουρία για άμεση αίσθηση ανακούφισης.","Βοηθά στην καλύτερη όψη της επιδερμίδας μετά από δραστηριότητα.","Απορροφάται γρήγορα, ιδανική για μασάζ."],
            ...
            science: `<h3>Επιστημονική Ανάλυση</h3>${hcpTable([{ing:"Urea (Ουρία)", moa:"Humectant + κερατολυτική δράση. Βελτιώνει τη διείσδυση των δραστικών."}, {ing:"Arnica montana", moa:"Αντιφλεγμονώδης δράση μέσω αναστολής NF-κB μονοπατιών."}, {ing:"Origanum oil", moa:"Sensory counter-irritant και τοπικό warming sensation."}])}`,
            bibliography: "<p>Wohlrab J (2018). Urea in Dermatology. | Lyss G, et al. (1998). Helenalin mechanism.</p>"
        }
    },
    {
        ...
        description: {
            consumer: consumerBlock({
                ...
                bullets: ["Με ψευδάργυρο που συμβάλλει στη φυσιολογική λειτουργία του ανοσοποιητικού.","Περιέχει Ginger και NAC για υποστήριξη.","Ιδανικό για περιόδους αυξημένων απαιτήσεων."],
                howTo: "1 κάψουλα ημερησίως.",
                cautions: "Τα συμπληρώματα δεν υποκαθιστούν ισορροπημένη διατροφή."
            }),
            science: `<h3>Επιστημονική Ανάλυση</h3>${hcpTable([{ing:"Zinc", moa:"Ρόλος σε έμφυτη/επίκτητη ανοσία και epithelial integrity."}, {ing:"Ginger (Zingiber officinale)", moa:"Μείωση 5-LOX/COX δραστηριότητας και αντιφλεγμονώδης σηματοδότηση."}, {ing:"NAC", moa:"Πρόδρομος γλουταθειόνης, redox support."}])}`,
            bibliography: "<p>Reg. (EU) 432/2012 | Grzanna R, et al. (2005). Ginger anti-inflammatory actions.</p>"
        }
    },
    {
        name: 'Revitacell Plus Face cream 50ml',
        description: {
            consumer: "<h3>Αντιοξειδωτική Προστασία & Αντιγήρανση</h3><p>Κρέμα προσώπου που συμβάλλει στη λείανση των λεπτών γραμμών και στην ενεργοποίηση της «πρωτεΐνης της νεότητας».</p>",
    ...
    },
    {
        ...
        description: {
            consumer: "<h3>Ισορροπία Εντερικής Χλωρίδας</h3><ul><li>18 στελέχη για ευρύ φάσμα αποικισμού.</li><li>Υποστηρίζει τη φυσιολογική εντερική λειτουργία.</li></ul>",
            science: `<h3>Επιστημονική Ανάλυση</h3>${hcpTable([{ing:"18 Probiotic Strains", moa:"Competitive exclusion παθογόνων, παραγωγή SCFA (βουτυρικό), ενίσχυση φραγμού."}])}`,
    ...
    },
    {
        ...
        description: {
            ...
            science: `<h3>Επιστημονική Ανάλυση</h3>${hcpTable([{ing:"Magnesium", moa:"Συμπαράγοντας σε >300 ενζυμικές αντιδράσεις, ATP biology, NMDA modulation."}, {ing:"Vitamin B6", moa:"Υποστήριξη ενεργειακού μεταβολισμού και νευροδιαβίβασης."}])}`,
            bibliography: "EU Reg. 432/2012 | Prasad AS (2008). Magnesium in human health."
        }
    },
    {
        name: 'NUTRI MX JOINT',
        description: {
            ...
            science: `<h3>Επιστημονική Ανάλυση</h3>${hcpTable([{ing:"Glucosamine/Chondroitin", moa:"Δομικοί πρόδρομοι γλυκοζαμινογλυκανών χόνδρου."}, {ing:"MSM", moa:"Οργανική πηγή θείου για σύνθεση συνδετικού ιστού."}])}`,
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    products.forEach((p, index) => {
        ...
        row.innerHTML = `
            ...
            <td><span class="badge gifts">0</span></td>
...
function showProductDetails(index){
    ...
    document.getElementById('productModal').innerHTML = `
        <div class="modal-content">
            ...
            <img src="${imgPath}" onerror="this.style.display='none'" style="max-width:200px; display:block; margin:15px auto; border-radius:10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
            ...
            <div style="margin-top:20px; text-align:center; padding:15px; border-top:1px solid #eee;">
                ...
                <input type="number" id="modalQty" value="${tableInput.value}" style="width:70px; padding:8px; border-radius:5px; border:1px solid #ccc;">
                <button class="btn-main btn-email" style="margin-left:10px; padding:8px 20px;" onclick="updateFromModal(${index})">Ενημέρωση Φόρμας</button>
            </div>
            <div class="compliance-note">Σημείωση: Οι περιγραφές για το κοινό αφορούν καλλυντική/διατροφική χρήση και δεν υποκαθιστούν ιατρική συμβουλή.</div>
        </div>`;
