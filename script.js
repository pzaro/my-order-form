// ============================================================
// ZARKOLIA HEALTH - ΠΛΗΡΕΣ SCRIPT ΕΦΑΡΜΟΓΗΣ
// ============================================================
...
// ============================================================
// 4) PRODUCT DETAILS — Consumer + HCP MoA (Optimized)
// ============================================================
const productDetails = [
  {
    ...
    description: {
      consumer: consumerBlock({
        ...
        bullets: [
          "Σπρέι υψηλής περιεκτικότητας σε αλκοόλη για άμεση υγιεινή των χεριών.",
          "Εμπλουτισμένο με PMD (Citriodora) για δημιουργία «απωθητικού προφίλ» έναντι εντόμων.",
          "Ιδανικό για εξωτερικές δραστηριότητες, ταξίδια και καθημερινή άνεση."
        ],
        howTo: "Ψεκάστε ομοιόμορφα και αφήστε να στεγνώσει. Μην ξεβγάζετε.",
        cautions: "Εύφλεκτο. Αποφύγετε την επαφή με μάτια και ερεθισμένο δέρμα."
      }),
      science: `
        <h3>Επιστημονική Προσέγγιση</h3>
        <p>Λειτουργικός καθαρισμός με παράλληλη οσφρητική παρέμβαση.</p>
        ${hcpTable([
          { ing: "Alcohol Denat. (70% v/v)", moa: "Μετουσίωση πρωτεϊνών και λύση λιπιδικής μεμβράνης παθογόνων μικροοργανισμών." },
          { ing: "PMD (p-menthane-3,8-diol)", moa: "Παρεμβολή στους χημειοαισθητήρες των εντόμων, εμποδίζοντας τον εντοπισμό του ξενιστή." }
        ])}`,
      bibliography: `<p>—</p>`
    }
  },

  // --- ΣΥΝΕΝΩΣΗ ZPLAST (40gr & 100gr) ---
  {
    ...
    description: {
      consumer: consumerBlock({
        ...
        bullets: [
          "Προηγμένη σύνθεση για ξηρό, ευαίσθητο ή ταλαιπωρημένο δέρμα.",
          "Υποστηρίζει τη φυσική ανάπλαση της επιδερμίδας και μειώνει το αίσθημα «τραβήγματος».",
          "Πλούσια υφή που προστατεύει από εξωτερικές επιθέσεις (κρύο, τριβή)."
        ],
        howTo: "Εφαρμογή 2-3 φορές την ημέρα στις πάσχουσες περιοχές.",
        cautions: "Μόνο για εξωτερική χρήση. Αποφύγετε την έκθεση στον ήλιο αμέσως μετά την εφαρμογή."
      }),
      science: `
        <h3>Μηχανισμός Δερματικής Αποκατάστασης</h3>
        ${hcpTable([
          { ing: "Hypericum Perforatum", moa: "Πλούσιο σε υπερφορίνη, ενισχύει την επανεπιθηλιοποίηση και προσφέρει ισχυρή αντιοξειδωτική δράση." },
          { ing: "Chios Mastic Oil", moa: "Ενεργοποιεί τη σύνθεση κολλαγόνου και παρουσιάζει ήπια αντιμικροβιακή δραστηριότητα in vitro." },
          { ing: "Calamine & Sea Buckthorn", moa: "Συνδυασμός στυπτικής δράσης και λιπαρών οξέων (Ω-7) για την αποκατάσταση του λιπιδικού φραγμού." }
        ])}`,
      bibliography: `<p>—</p>`
    }
  },
  {
    ...
    description: {
      // Ίδια περιγραφή με την 40gr
      consumer: consumerBlock({
        title: "Εντατική Φροντίδα & Καταπράυνση Φραγμού",
        bullets: ["Προηγμένη σύνθεση για ξηρό, ευαίσθητο ή ταλαιπωρημένο δέρμα.", "Υποστηρίζει τη φυσική ανάπλαση της επιδερμίδας και μειώνει το αίσθημα «τραβήγματος».", "Πλούσια υφή που προστατεύει από εξωτερικές επιθέσεις (κρύο, τριβή)."],
        howTo: "Εφαρμογή 2-3 φορές την ημέρα στις πάσχουσες περιοχές.",
        cautions: "Μόνο για εξωτερική χρήση."
      }),
      science: `<h3>Μηχανισμός Δερματικής Αποκατάστασης</h3>${hcpTable([{ ing: "Hypericum Perforatum", moa: "Ενισχύει την επανεπιθηλιοποίηση και προσφέρει αντιοξειδωτική δράση." }, { ing: "Chios Mastic Oil", moa: "Ενεργοποιεί τη σύνθεση κολλαγόνου και προσφέρει δερματικό comfort." }, { ing: "Sea Buckthorn (Ω-7)", moa: "Αναπλήρωση λιπιδίων και ενίσχυση ελαστικότητας." }])}`,
      bibliography: `<p>—</p>`
    }
  },

  {
    ...
    description: {
      consumer: consumerBlock({
        ...
        bullets: [
          "Με Ουρία για ταχεία απορρόφηση και ενυδάτωση.",
          "Βελτιώνει την όψη της επιδερμίδας μετά από μώλωπες ή έντονη μυϊκή καταπόνηση.",
          "Ιδανικό για τοπικό μασάζ με αίσθηση αναζωογόνησης."
        ],
        howTo: "Απλώστε επαρκή ποσότητα και κάντε μασάζ μέχρι να απορροφηθεί πλήρως.",
        cautions: "Περιέχει Άρνικα· να μην χρησιμοποιείται σε ανοιχτές πληγές."
      }),
      science: `
        <h3>Επιστημονική Ανάλυση</h3>
        ${hcpTable([
          { ing: "Urea", moa: "Keratolytic & Humectant: Αυξάνει τη διαπερατότητα της κεράτινης στιβάδας για ταχύτερο delivery των δραστικών." },
          { ing: "Arnica (Helenalin)", moa: "Αναστολή NF-κB μονοπατιών, μειώνοντας την εμφάνιση οιδήματος και εκχυμώσεων." },
          { ing: "Carvacrol", moa: "Τοπική υπεραιμία (sensory counter-irritant) που βοηθά στην απομάκρυνση φλεγμονωδών παραγόντων." }
        ])}`,
      bibliography: `<p>—</p>`
    }
  },

  // --- ΣΥΝΕΝΩΣΗ Z-BOOST (12 & 30 caps) ---
  {
    ...
    description: {
      consumer: consumerBlock({
        ...
        bullets: [
          "Σύνθεση με Ψευδάργυρο, Ginger και NAC για μέγιστη υποστήριξη.",
          "Ο Ψευδάργυρος συμβάλλει στη φυσιολογική λειτουργία του ανοσοποιητικού συστήματος.",
          "Προστασία από το οξειδωτικό στρες σε περιόδους έντονης σωματικής ή πνευματικής κόπωσης."
        ],
        howTo: "1 κάψουλα ημερησίως μετά το γεύμα.",
        cautions: "Συμπλήρωμα διατροφής· δεν υποκαθιστά μια ισορροπημένη δίαιτα."
      }),
      science: `
        <h3>Μοριακή Υποστήριξη</h3>
        ${hcpTable([
          { ing: "Zinc & Selenium", moa: "Ρύθμιση της διαφοροποίησης των Τ-λεμφοκυττάρων και ενίσχυση της GPx (γλουταθειόνη)." },
          { ing: "Ginger (Gingerols)", moa: "Ρύθμιση των οδών 5-LOX και COX για μείωση της συστηματικής φλεγμονώδους σηματοδότησης." },
          { ing: "NAC & CoQ10", moa: "Πρόδρομος GSH και μιτοχονδριακή υποστήριξη για βέλτιστη ενεργειακή απόδοση των κυττάρων." }
        ])}`,
      bibliography: `<p>—</p>`
    }
  },
  {
    ...
    description: {
      // Ίδια περιγραφή με το 30 caps
      consumer: consumerBlock({
        title: "Ολοκληρωμένη Θωράκιση Ανοσοποιητικού",
        bullets: ["Σύνθεση με Ψευδάργυρο, Ginger και NAC.", "Συμβάλλει στη φυσιολογική λειτουργία του ανοσοποιητικού.", "Ιδανικό για άμεση τόνωση σε απαιτητικές περιόδους."],
        howTo: "1 κάψουλα ημερησίως.",
        cautions: "Να μην γίνεται υπέρβαση της συνιστώμενης δόσης."
      }),
      science: `<h3>Μοριακή Υποστήριξη</h3>${hcpTable([{ ing: "Zinc & Ginger", moa: "Συνέργεια στην ανοσορρύθμιση και στη ρύθμιση των COX/LOX." }, { ing: "NAC & CoQ10", moa: "Redox support και μιτοχονδριακή παραγωγή ATP." }])}`,
      bibliography: `<p>—</p>`
    }
  },

  // --- ΒΕΛΤΙΩΣΗ ΚΑΛΛΥΝΤΙΚΩΝ (REVITACELL / HYDRALIA) ---
  {
    name: 'Revitacell Plus Face cream 50ml',
    image: 'images/revitacell.jpg',
    description: {
      consumer: consumerBlock({
        title: "Επιγενετική Αντιγήρανση & Επαναφορά Λάμψης",
        bullets: [
          "Ενεργοποιεί την «πρωτεΐνη Klotho» (πρωτεΐνη της νεότητας) για κυτταρική μακροζωία.",
          "Αισθητή μείωση της όψης των ρυτίδων και βελτίωση της ελαστικότητας.",
          "Πλούσια σε αντιοξειδωτικά λιπίδια από Ρόδι και Μαστίχα."
        ],
        howTo: "Εφαρμόστε πρωί και βράδυ σε καθαρό πρόσωπο και λαιμό.",
        cautions: "Κατάλληλο για όλους τους τύπους δέρματος."
      }),
      science: `
        <h3>Επιστημονικό Rationale</h3>
        ${hcpTable([
          { ing: "Mastic Gum Extract", moa: "Επάγει την έκφραση της Klotho protein στους ινοβλάστες, επιβραδύνοντας την κυτταρική γήρανση." },
          { ing: "Pomegranate Seed Oil", moa: "Πλούσιο σε πουνικικό οξύ (Ω-5)· αναστέλλει τις μεταλλοπρωτεϊνάσες (MMP-1) που αποδομούν το κολλαγόνο." }
        ])}`,
      bibliography: `<p>—</p>`
    }
  },

  {
    ...
    description: {
      consumer: consumerBlock({
        ...
        bullets: [
          "Στοχευμένη δράση κατά του πρηξίματος (σακούλες) και των μαύρων κύκλων.",
          "Βελτιώνει τη μικροκυκλοφορία στην περιοχή των ματιών για ξεκούραστη όψη.",
          "Προσφέρει άμεση φωτεινότητα χάρη στη βελτίωση της δερματικής υφής."
        ],
        howTo: "Ταμποναριστά πρωί και βράδυ στην περιοχή των ματιών.",
        cautions: "Οφθαλμολογικά ελεγμένη σύνθεση."
      }),
      science: `
        <h3>Μηχανισμός Δράσης</h3>
        ${hcpTable([
          { ing: "Escin (Ιπποκαστανιά)", moa: "Venotonic profile: Μειώνει τη διαπερατότητα των τριχοειδών, περιορίζοντας το οίδημα στην περικογχική περιοχή." },
          { ing: "Arnica Extract", moa: "Βοηθά στην απορρόφηση των χρωστικών του αίματος που ευθύνονται για τους μαύρους κύκλους." }
        ])}`,
      bibliography: `<p>—</p>`
    }
  },

  {
    ...
    description: {
      consumer: consumerBlock({
        ...
        bullets: [
          "Συνδυασμός Υαλουρονικού οξέος για «γέμισμα» των λεπτών γραμμών.",
          "Ενισχύει τη δέσμευση υγρασίας στις βαθύτερες στοιβάδες της επιδερμίδας.",
          "Ιδανική βάση για μακιγιάζ με μεταξένια υφή."
        ],
        howTo: "Πρωί σε καθαρή επιδερμίδα για προστασία και ενυδάτωση.",
        cautions: "Χωρίς parabens."
      }),
      science: `
        <h3>Υδροδυναμική Επιδερμίδας</h3>
        ${hcpTable([
          { ing: "Sodium Hyaluronate (LMW)", moa: "Το χαμηλού μοριακού βάρους υαλουρονικό διεισδύει βαθύτερα, προκαλώντας plumping effect εκ των έσω." },
          { ing: "Jojoba Oil", moa: "Βιομιμητικοί εστέρες κηρού που ρυθμίζουν την παραγωγή σμήγματος και ενισχύουν τον λιπιδικό φραγμό." }
        ])}`,
      bibliography: `<p>—</p>`
    }
  },

  {
    ...
    description: {
      consumer: consumerBlock({
        ...
        bullets: [
          "Revitacell Plus + Hydralia + Revitace Eyes: Η πλήρης ρουτίνα σας.",
          "Συνδυαστική δράση για ενυδάτωση, σύσφιξη και λάμψη.",
          "Το απόλυτο δώρο για την υγεία της επιδερμίδας."
        ],
        howTo: "Πρωί: Hydralia & Eyes. Βράδυ: Revitacell & Eyes.",
        cautions: "Συνέργεια δραστικών για μέγιστο αποτέλεσμα."
      }),
      science: `
        <h3>Συνεργιστικό Μοντέλο</h3>
        <p>Ο συνδυασμός επιτυγχάνει ταυτόχρονη ρύθμιση του επιγενετικού ρολογιού (Klotho), της υδροδυναμικής (HA) και της μικροκυκλοφορίας (Escin).</p>
        ${hcpTable([
          { ing: "Total Routine", moa: "Πολυεπίπεδη στόχευση: Αντιοξείδωση, Φραγμός, Κολλαγόνο, Αποσυμφόρηση." }
        ])}`,
      bibliography: `<p>—</p>`
    }
  }
