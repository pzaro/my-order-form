// ============================================================
// ZARKOLIA HEALTH - THE DEFINITIVE SCIENTIFIC ERP v9.0
// ============================================================
...
// --- 3. ΠΛΗΡΗΣ ΒΑΣΗ ΔΕΔΟΜΕΝΩΝ ΠΕΛΑΤΩΝ (LOOKUP) ---
const knownCustomers = {
    ...
    "047359704": { eponimia: "ΦΑΡΑΚΛΙΩΤΗΣ ΔΗΜΗΤΡΙΟΣ ΘΩΜΑ", doy: "ΧΑΛΚΙΔΑΣ", phone: "2221060657", email: "farmakeiokamares@gmail.com" },
    "047862819": { eponimia: "ΠΑΠΑΔΑΚΗΣ ΝΙΚΟΛΑΟΣ ΚΩΝΣΤΑΝΤΙΝΟ", doy: "ΧΑΛΚΙΔΑΣ", email: "nikotero@gmail.com" },
    "056068437": { eponimia: "ΓΑΝΑ ΒΑΣΙΛΙΚΗ ΕΥΑΓΓΕΛΟ", doy: "ΓΙΑΝΝΙΤΣΩΝ", phone: "2382082077", email: "vassogana@gmail.com" },
    ...
    "095141629": { eponimia: "ΔΟΜΙΚΗ Π ΠΑΥΛΙΔΗΣ Α.Ε", doy: "ΓΙΑΝΝΙΤΣΩΝ", phone: "2382099599", email: "g.apostolidis@domiki-pavlides.gr" },
    ...
    "120774602": { eponimia: "ΚΙΤΚΑ ΑΝΑΣΤΑΣΙΑ ΧΡΗΣΤΟ", doy: "ΓΙΑΝΝΙΤΣΩΝ", phone: "2382 063656", email: "a_kitka@yahoo.gr" },
    ...
    "134848587": { eponimia: "ΔΟΥΛΚΕΡΙΔΗΣ ΚΟΣΜΑΣ ΠΑΝΑΓΙΩΤΗ", doy: "ΕΔΕΣΣΑΣ", phone: "2382 042630", email: "kdoulker@hotmail.com" },
    ...
    "300639167": { eponimia: "ΤΡΙΑΝΤΑΦΥΛΛΙΔΟΥ ΕΛΕΝΗ ΑΡΙΣΤΕΙΔΗ", doy: "ΟΡΕΣΤΙΑΔΑΣ", phone: "2553024243", email: "eleni.triantafillidou@gmail.com" },
    ...
    "800414167": { eponimia: "ΜΑΧΜΟΥΡΙΔΟΥ ΚΑΙ ΣΙΑ Ο", doy: "ΟΡΕΣΤΙΑΔΑΣ", phone: "2553024676", email: "www.maxmouridou@hotmail.gr" },
    "800472889": { eponimia: "ΦΑΡΜΑΚΕΙΑ ΣΠΥΡΙΔΗΣ Δ ΒΑΛΑΣΙΔΟΥ ΙΣ Ο", doy: "ΚΙΛΚΙΣ", phone: "2341023040", email: "dimitris_sp@yahoo.com" },
    "800586973": { eponimia: "ΦΑΡΜΑΚΕΙΟ ΦΑΡΜΑΚΗΣ ΙΩΑΝΝΗΣ ΚΑΙ ΣΙΑ Ο", doy: "ΓΙΑΝΝΙΤΣΩΝ", phone: "+30 2391091551", email: "farmakisg21@hotmail.gr" },
    "800616945": { eponimia: "ΣΥΣΤΕΓΑΣΜΕΝΑ ΦΑΡΜΑΚΕΙΑ ΨΥΧΟΓΥΟΥ ΑΙΚΑΤΕΡΙΝΗ - ΨΥΧΟΓΥΟΥ ΣΟΦΙΑ Ο.Ε", doy: "ΕΔΕΣΣΑΣ", phone: "2381022232", email: "anaspsi@gmail.com" },
    ...
    "800759157": { eponimia: "ΣΥΣΤΕΓΑΣΜΕΝΑ ΦΑΡΜΑΚΕΙΑ ΧΡΗΣΤΟΥ ΠΕΛΑΓΙΑ ΚΑΙ ΣΑΡΗΓΚΙΟΛΗΣ Ο", doy: "ΕΔΕΣΣΑΣ", phone: "+302384024298", email: "orestis.sarigkiolis@gmail.com" },
    "800972362": { eponimia: "ΣΥΣΤΕΓΑΣΜΕΝΑ ΦΑΡΜΑΚΕΙΑ ΤΟΠΟΥΖΙΔΗΣ Γ ΚΑΙ ΤΟΠΟΥΖΙΔΗΣ Κ Ο", doy: "ΚΙΛΚΙΣ", phone: "2343022000", email: "e.topouzidou@yahoo.gr" },
    ...
    "802644097": { eponimia: "ΣΥΣΤΕΓΑΖΟΜΕΝΑ ΦΑΡΜΑΚΕΙΑ ΕΥΑ ΚΟΤΙΔΟΥ ΠΛΑΤΗΣ ΒΑΣΙΛΕΙΟΣ Ο.Ε", doy: "ΕΔΕΣΣΑΣ", phone: "2384022908", email: "evakotidou@gmail.com" },
    ...
    "999296071": { eponimia: "ΚΑΡΑΟΥΛΑΝΗ ΕΥΑΓΓΕΛΙΑ ΚΑΙ ΣΙΑ Ο", doy: "ΓΙΑΝΝΙΤΣΩΝ", phone: "2382 042299", email: "psiamanta@hotmail.com" },
    "999387480": { eponimia: "ΜΗΤΚΑΣ ΑΔΑΜΑΝΤΙΟΣ ΚΑΙ ΣΙΑ Ε", doy: "ΑΛΕΞΑΝΔΡΟΥΠΟΛΗΣ", mobile: "6945411342", email: "farmakiomitkas@gmail.com" }
};

// --- 4. ΠΡΟΪΟΝΤΑ & ΤΙΜΕΣ (BRUISE OFF @ 5.60) ---
const products = [
...
const productDetails = {
    ...
    "Bruise Off": {
        science: `<h3>Μοριακό Rationale Αντιφλεγμονώδους Δράσης</h3>` + hcpTable([
            ...
            { ing: "Carvacrol", moa: "TRPV1 Agonist για τοπική υπεραιμία και αποσυμφόρηση." }
        ]),
    ...
    "Revitace Eyes cream": {
        science: hcpTable([{ing: "Escin", moa: "Venotonic profile reducing edema (bags)." }, {ing: "Arnica", moa: "Heme degradation support for dark circles." }]),
        biblio: biblioList(["Gallelli L (2019). PubMed:31562234"])
    },
    "NUTRI MX PROBIOTIC": {
        science: `<h3>Μικροβιακή Ομοιόσταση</h3>` + hcpTable([{ing: "18 Strains", moa: "Competitive exclusion and Tregs induction." }, {ing: "Butyrate", moa: "Colonocyte nutrition." }]),
        biblio: biblioList(["Karamanolis GP (2019)."])
    },
    "NUTRI MX MAGNESIUM": {
        science: hcpTable([{ing: "Magnesium", moa: "NMDA Antagonist and ATP cofactor." }, {ing: "Vit B6", moa: "Intracellular magnesium chaperone." }]),
        biblio: biblioList(["EFSA Journal (2010)."])
    }
};
...
// Εμπορική Πολιτική (Δώρα & Εκπτώσεις)
...
function showInfo(name) {
    let lookup = name.includes("Total Repair") ? "Zplast Total Repair" : (name.includes("Cream") ? "ZplastCream" : (name.includes("Bruise Off") ? "Bruise Off" : (name.includes("Z-boost") ? "Z-boost" : (name.includes("Probiotic") ? "NUTRI MX PROBIOTIC" : (name.includes("Magnesium") ? "NUTRI MX MAGNESIUM" : name)))));
    const p = productDetails[lookup] || { science: "—", biblio: "—" };
    const modal = document.getElementById('productModal');
    let imgPath = p.img ? p.img : `images/${name}.jpg`;

    modal.innerHTML = `
        <div class="modal-content">
            <span style="position:absolute;top:20px;right:20px;cursor:pointer;font-size:2.5rem;" onclick="this.parentElement.parentElement.style.display='none'">&times;</span>
