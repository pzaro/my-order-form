...
// ΟΙ ΠΛΗΡΕΙΣ ΠΕΡΙΓΡΑΦΕΣ ΕΙΝΑΙ ΕΔΩ
const productDetails=[
    ...
    },
    {
        ...
        description: {
            ...
            bibliography: `<p>Παρακαλώ προσθέστε εδώ τη βιβλιογραφία για το Zplast Cream.</p>`
        }
    },
    {
    ...
    },
    {
        ...
        description: {
            consumer: `<h3>Ολοκληρωμένη Προσέγγιση στην Περιποίηση</h3><p>Η σειρά περιποίησης προσώπου της Zarkolia αποτελεί ένα ολοκληρωμένο πρωτόκολλο φροντίδας, αποτελούμενο από τρία εξειδικευμένα προϊόντα που δρουν συνεργατικά: την αντιρυτιδική Revitacell Plus, την υπερ-ενυδατική Hydralia και τη στοχευμένη κρέμα ματιών Revitacell Eyes. Κάθε φόρμουλα είναι σχεδιασμένη ώστε να αλληλοσυμπληρώνεται, προσφέροντας ένα ολιστικό αποτέλεσμα για μια επιδερμίδα που ακτινοβολεί υγεία, νεανικότητα και λάμψη.</p>`,
            science: `<h3>Τα 3 Βήματα της Περιποίησης Zarkolia</h3><p><strong>1. Revitacell Plus Face Cream:</strong> Ο πυρήνας της αντιγηραντικής δράσης. Η Μαστίχα Χίου ενισχύει την παραγωγή της "πρωτεΐνης της νεότητας" Klotho, ενώ το Έλαιο Ροδιού & Super Berries παρέχουν ισχυρή αντιοξειδωτική προστασία.</p><p><strong>2. Hydralia Face Cream:</strong> Η εξειδικευμένη λύση για άμεση και βαθιά ενυδάτωση. Το Υαλουρονικό Οξύ "γεμίζει" τις λεπτές γραμμές, ενώ τα έλαια Αβοκάντο, Jojoba & Αμυγδάλου θρέφουν και αποκαθιστούν τον δερματικό φραγμό.</p><p><strong>3. Revitacell Eyes Cream:</strong> Στοχευμένη λύση για μαύρους κύκλους και πρήξιμο. Η Ιπποκαστανιά βελτιώνει τη μικροκυκλοφορία και η Άρνικα βοηθά στην απορρόφηση των μωλώπων.</p>`,
    ...
    {
        name:'Revitacell + Face cream 50ml',
        description: {
