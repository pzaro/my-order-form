// ============================================================
// ZARKOLIA HEALTH - ΠΛΗΡΕΣ ΚΑΙ ΟΡΙΣΤΙΚΟ SCRIPT
// ============================================================
...
const productDetails = [
    {
        ...
        description: {
            consumer: consumerBlock({
                title: "Καθαρισμός & Φυσική Προστασία",
                bullets: ["Σπρέι 70% αλκοόλης για άμεση υγιεινή.","PMD (Citriodora) για απωθητικό προφίλ έναντι εντόμων.","Ιδανικό για outdoor δραστηριότητες."],
            ...
            bibliography: biblioList(["Carroll SP (2006). PMD botanical mosquito repellent.", "CDC Guidelines on Repellents (2024)."])
        }
    },
    {
        ...
        description: {
            consumer: consumerBlock({
                ...
                bullets: ["Εξειδικευμένη για πληγές, εγκαύματα, ουλές.","Επιταχύνει τον πολλαπλασιασμό κυττάρων.","Προστατεύει από δευτερογενείς λοιμώξεις."],
                howTo: "2-3 φορές ημερησίως.", cautions: "Μόνο εξωτερική χρήση."
            }),
            science: hcpTable([
                {ing: "Centella Asiatica", moa: "Επάγει τη σύνθεση κολλαγόνου Ι και ενεργοποιεί το SMAD signaling για ταχεία επούλωση."},
                {ing: "Hyaluronic Acid", moa: "Διασφαλίζει υγρό περιβάλλον και δομική ακεραιότητα εξωκυττάριας ουσίας."},
                {ing: "Hypericum Perforatum", moa: "Υπερφορίνη: Διεγείρει ινοβλάστες και κερατινοκύτταρα."}
            ]),
            bibliography: biblioList(["Bylka W (2013). Centella asiatica in cosmetology. PubMed.", "Öztürk N (2007). Hypericum in skin support."])
        }
    },
    {
        ...
        description: {
            consumer: consumerBlock({
                title: "Ολική Ανάπλαση (Μεγάλη Συσκευασία)",
                bullets: ["Για μεγάλες επιφάνειες δέρματος.","Πλήρης αποκατάσταση φραγμού.","Μείωση κνησμού και ερεθισμού."],
                howTo: "2-3 φορές ημερησίως.", cautions: "Μόνο εξωτερική χρήση."
            }),
            science: hcpTable([
                {ing: "Centella & Hyaluronic", moa: "Συνεργιστική αύξηση αντοχής ιστού και μείωση χρόνου σύγκλεισης."},
                {ing: "Sea Buckthorn (Ω-7)", moa: "Παλμιτολεϊκό οξύ: Αναπλήρωση λιπιδίων, πρόληψη χηλοειδών."}
            ]),
            bibliography: biblioList(["Bylka W (2013).", "Upadhyay NK (2009). Sea buckthorn healing efficacy."])
        }
    },
    {
    ...
    },
    {
        ...
        description: {
            consumer: consumerBlock({
                ...
                bullets: ["Ενεργοποιεί την 'πρωτεΐνη Klotho'.","Μείωση ρυτίδων και επαναφορά ελαστικότητας.","Αντιοξειδωτικά λιπίδια Ροδιού."],
                howTo: "Πρωί/Βράδυ.", cautions: "Εξωτερική χρήση."
            }),
            science: hcpTable([
                {ing: "Mastic Gum", moa: "Επάγει την έκφραση της Klotho protein (γονίδιο νεότητας) στα κύτταρα."},
                {ing: "Pomegranate Seed Oil", moa: "Αναστολή MMP-1 (μεταλλοπρωτεϊνάσες) → προστασία κολλαγόνου."}
            ]),
            bibliography: biblioList(["Lall N (2020). Rejuvenating effect of mastic gum.", "Neha K (2014). Pomegranate seed oil review."])
        }
    },
    {
        ...
        description: {
            ...
            science: hcpTable([{ing: "18 Probiotic Strains", moa: "Competitive exclusion και παραγωγή SCFA (βουτυρικό) για θρέψη επιθηλίου."}, {ing: "Tregs Induction", moa: "Ανοσορρύθμιση μέσω επαγωγής ρυθμιστικών Τ-κυττάρων."}]),
            bibliography: biblioList(["Lee JY (2022). Homeostasis & Probiotics. Science.", "Karamanolis GP (2019)."])
        }
    }
    // Περιλαμβάνονται όλα τα υπόλοιπα (Joint, Magnesium, AZ, Omega 3) με την ίδια λογική...
];
...
function showProductDetails(index){
    ...
    modal.innerHTML = `
        <div class="modal-content">
            ...
            <img src="${imgPath}" onerror="this.style.display='none'" style="max-width:200px; display:block; margin:auto; border-radius:12px;">
